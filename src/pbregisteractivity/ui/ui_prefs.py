...
class Ui_Prefs(object):
    def setupUi(self, Prefs):
        ...
        self.spinDayDuration = QtWidgets.QDoubleSpinBox(Prefs)
        self.spinDayDuration.setMaximum(24.0)
        self.spinDayDuration.setSingleStep(0.25)
        self.spinDayDuration.setProperty("value", 0.0)
        ...
        self.layoutMisc = QtWidgets.QHBoxLayout()
        ...
        self.layoutMisc.addItem(spacerItem1)
        self.layoutData.setLayout(1, QtWidgets.QFormLayout.FieldRole, self.layoutMisc)
        ...
        self.lblAutoSave = QtWidgets.QLabel(Prefs)
        self.lblAutoSave.setObjectName("lblAutoSave")
        self.layoutData.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.lblAutoSave)
        self.layoutAutoSave = QtWidgets.QHBoxLayout()
        self.layoutAutoSave.setObjectName("layoutAutoSave")
        self.cbAutoSave = QtWidgets.QCheckBox(Prefs)
        self.cbAutoSave.setObjectName("cbAutoSave")
        self.layoutAutoSave.addWidget(self.cbAutoSave)
        self.layoutData.setLayout(3, QtWidgets.QFormLayout.FieldRole, self.layoutAutoSave)
        ...
        self.buttonBox.accepted.connect(Prefs.accept) # type: ignore
        self.buttonBox.rejected.connect(Prefs.reject) # type: ignore
...
"Si 0, il n\'y a pas de regroupement."))
        ...
        self.cbToTray.setToolTip(_translate("Prefs", "<html><head/><body><p>Minimisation de l\'application en zone de notification plutôt que dans la barre des tâches</p></body></html>"))
        ...
        self.lblAutoSave.setText(_translate("Prefs", "Sauvegarde auto:"))
        self.cbAutoSave.setToolTip(_translate("Prefs", "<html><head/><body><p>Lorsque le programme se termine, sauvegarde automatiquement la période de temps en cours de comptage. Si aucun nom n\'a été donné, crée un nom par défaut.</p></body></html>"))
        self.cbAutoSave.setText(_translate("Prefs", "Si plus de 10 min"))
