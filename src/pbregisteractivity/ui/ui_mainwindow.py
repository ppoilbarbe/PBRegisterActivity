...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutSelection = QtWidgets.QVBoxLayout(self.layoutWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblFilter.setText(_translate("MainWindow", "Filtre:"))
        self.edtFilter.setToolTip(_translate("MainWindow", "N\'affiche que les plages dont\n"
"le nom contient le texte saisi"))
        self.cbFilterType.setToolTip(_translate("MainWindow", "<html><head/><body><p>Type de filtre:</p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:600;\">N</span>: sur le nom</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:600;\">C</span>: sur le commentaire</li><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\"><span style=\" font-weight:600;\">2</span>: sur les deux</li></ul></body></html>"))
        self.cbFilterType.setText(_translate("MainWindow", "?"))
        ...
        self.lcdDuration.setToolTip(_translate("MainWindow", "Durée calculée entre l\'heure de début et l\'heure courante."))
        ...
        self.cbbActivities.setToolTip(_translate("MainWindow", "Nom de l\'action en cours d\'enregistrement."))
        self.edtComment.setToolTip(_translate("MainWindow", "Commentaire à associer à l\'activité"))
