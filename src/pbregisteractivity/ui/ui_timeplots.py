...
class Ui_TimePlots(object):
    def setupUi(self, TimePlots):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/images/icons/32x32/action_cal_timespent.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/images/icons/32x32/action_cal_timeline.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/images/icons/32x32/tool_piechart.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/images/icons/32x32/action_cal_journal.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/images/icons/32x32/action_revert.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/images/icons/32x32/action_cal_workweek.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnWorkWeek.setIcon(icon5)
        self.btnWorkWeek.setObjectName("btnWorkWeek")
        self.layoutActions.addWidget(self.btnWorkWeek)
        self.btnNextWeek = QtWidgets.QToolButton(TimePlots)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/images/icons/32x32/action_progress.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/images/icons/32x32/action_cal_day.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.deStart.setDate(QtCore.QDate(7999, 12, 29))
        ...
        self.lblDurations = QtWidgets.QLabel(TimePlots)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/images/icons/32x32/action_save.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonBox.accepted.connect(TimePlots.accept) # type: ignore
        self.buttonBox.rejected.connect(TimePlots.reject) # type: ignore
...
"et exportation CSV"))
        self.btnPrevWeek.setToolTip(_translate("TimePlots", "Reculer d\'une semaine"))
        self.btnWorkWeek.setToolTip(_translate("TimePlots", "Modifie les dates pour sélectionner la semaine courante"))
        self.btnNextWeek.setToolTip(_translate("TimePlots", "Avancer d\'une semaine"))
        ...
        self.deStart.setDisplayFormat(_translate("TimePlots", "ddd yyyy-MM-dd  "))
        ...
        self.deEnd.setDisplayFormat(_translate("TimePlots", "ddd yyyy-MM-dd   "))
        self.lblDurations.setText(_translate("TimePlots", "Durée jour"))
